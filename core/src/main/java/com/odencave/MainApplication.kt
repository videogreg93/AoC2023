...
class MainApplication(val initialScreen: () -> BasicScreen) : KtxGame<BasicScreen>(),
    ...
    val overlayViewport by lazy { FitViewport(Globals.WORLD_WIDTH, Globals.WORLD_HEIGHT, overlayCamera) }
...
//        KtxAsync.initiate()
        ...
        onScreenChange(initialScreen.invoke())
